      ...
      <tbody>
         ...
         if(mysqli_num_rows($select_cart) > 0){
            while($fetch_cart = mysqli_fetch_assoc($select_cart)){
               $sub_total = $fetch_cart['price'] * $fetch_cart['quantity']; // Hitung subtotal tanpa number_format()
         ?>
               <tr>
                     ...
                     <td>Rp.<?php echo number_format($sub_total); ?>/-</td> <!-- Format $sub_total saat menampilkan -->
         ...
         <tr class="table-bottom">
            ...
            <td>Rp.<?php echo number_format($grand_total); ?>/-</td> <!-- Format $grand_total saat menampilkan -->
