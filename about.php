...
<html lang="en">
  <head>
    <title>Manjurlink - About Page</title>
    <meta charset="utf-8" />
      ...
      <div class="container">
        <div class="row align-items-center py-5">
          <div class="col-md-8 text-white">
            <h1>About Us</h1>
            <p>
              Toko agen sembako manjur merupakan toko penyedia berbagai kebutuhan rumah tangga. Menjual barang eceran maupun grosir. Toko yang menyediakan berbagai macam produk seperti beras, minyak goreng, gula, tepung, dan bahan makanan
              lainnya dengan harga yang terjangkau dengan pelayanan yang ramah dan cepat membuat pengalaman berbelanja menjadi lebih menyenangkan.
            </p>
          </div>
          <div class="col-md-4">
            <img class="rounded-3" src="assets/img/RPL/Tokomanjur.jpg" alt="About Hero" style="width: 300px; height: 200px" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container py-5">
      <div class="row text-center pt-5 pb-3">
        <div class="col-lg-6 m-auto">
          ...
          <p>Di Toko Agen Sembako Manjur, kami menyediakan berbagai kebutuhan rumah tangga. Kami menjual barang secara eceran dan grosir untuk memenuhi kebutuhan Anda sehari-hari.</p>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 pb-5">
          <div class="h-100 py-5 services-icon-wap shadow">
            ...
            <h2 class="h5 mt-4 text-center">14 Hours Service</h2>
          </div>
        </div>
      </div>
    </section>
